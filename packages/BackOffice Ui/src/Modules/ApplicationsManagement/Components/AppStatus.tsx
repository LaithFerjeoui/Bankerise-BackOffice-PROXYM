...
const AppStatus = ({ edit, add }: any) => {
  return (
    <div className="mb-16 flex justify-center gap-9">
      <motion.div
        ...
        <motion.div
          ...
          <div className="mt-2">
            <input
              ...
              name="roleName"
              id="roleName"
              className=" block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 placeholder:text-gray-400 bg-[--inputBg] text-[--textSeconday] ring-gray-600 sm:text-sm sm:leading-6 px-1 backdrop:filter"
